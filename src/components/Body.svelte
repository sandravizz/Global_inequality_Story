...
<section style="margin-top: 50px;  margin-bottom: 100px">
  <p class="text-medium">
    <a
      ...
      >World production
    </a> is so high as it has never been before in history. Humanity has reached a level of efficiency that could feed the entire world. 💪
    Then why are so many people still living and dying in poverty? 😞
    These are the observations and questions that motivated me to create this project on globa inequality.
  </p>
  <p class="text-medium">      
    Global inequality has always been very high, 
    reflecting the persistence of a world economic system 
    that is extremely hierarchical both between countries and within them.     
    On the other hand, in more and more countries fascism is again on the rise.
    Both might be related as in particular extreme inequality leads to high level of frustration, fear, and anger. 😡
...
</a>  using the work of more than 100 researchers located on all continents.  
  This vast network collaborates with statistical institutions, tax authorities, universities, and international organizations, to harmonize international inequality data. 
  Thanks to this systematic data on inequality at the global level and over the last four decades trends can be made visual. 👀
</p>
</section>
