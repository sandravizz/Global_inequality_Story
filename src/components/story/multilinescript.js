...
export default {
	...
	steps: [
		...
		//The 2. step introduces all lines that made up the global average.
		{
			charts: [
				{
					key: "country",
		...
		//The 3. step introduces all lines that belong to Europe.
		{
			charts: [
				{
					key: "country",
