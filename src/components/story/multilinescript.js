  ...
  steps: [
    ...
    // --------------------------------------
    {
      ...
      description: {
        ...
        text3:
          "Despite these differences, all European countries remain far below the <span class='highlight' style='color:var(--color-global)'>global</span> inequality level.",
      },
    },
    // --------------------------------------
    // 6. USA vs. Europe
    ...
    // --------------------------------------
    {
      ...
      description: {
        ...
        text: "Across <span class='highlight' style='color:var(--color-south-america)'>South America</span> inequality remained high throughout the 80s and 90s. Many countries saw a decline during the 2000s due to stronger labour markets, improved education and expanded social programs<span class='fn' tabindex='0' data-note='UNCTAD (2023)'><sup>6</sup></span>. From the mid 2010s onward progress slowed as growth weakened and labour markets became more fragile<span class='fn' tabindex='0' data-note='ILO (2023)'><sup>7</sup></span>.",
        text2: "",
        text3:
          "Inequality rose sharply during the COVID 19 pandemic especially for informal and urban workers. Although fiscal support softened the impact it remained above pre pandemic levels in several countries<span class='fn' tabindex='0' data-note='IDB and World Bank COVID 19 reports'><sup>8</sup></span>.",
      },
    },
    // --------------------------------------
    // 8. USA - Mexico
    // --------------------------------------
    {
      ...
      description: {
        ...
        text: "<span class='highlight' style='color:var(--color-south-america)'>Mexico</span> is one of the most unequal countries and a direct neighbour to the US.",
        text2: "",
        text3:
    ...
    // --------------------------------------
    {
      ...
      description: {
        ...
        text: "<span class='highlight' style='color:var(--color-africa)'>South Africa 🇿🇦</span> is one of the most unequal countries in the world. It was already extreme in the 80s and increased further after the end of apartheid<span class='fn' tabindex='0' data-note='Sauer et al. (2020)'><sup>9</sup></span>.",
        text2:
          "High unemployment, strong divides between skilled and unskilled work and large spatial and educational inequalities keep distribution highly polarized<span class='fn' tabindex='0' data-note='UNCTAD (2023)'><sup>10</sup></span>.",
        text3:
          "Social grants reduce poverty but cannot compensate for the deep structural inequality generated in the labour market.<span class='fn' tabindex='0' data-note='Gradín (2023)'><sup>11</sup></span>.",
      },
    },
    // --------------------------------------
    ...
    // --------------------------------------
    {
      ...
      description: {
        ...
        text2:
          "Stable labour institutions, broad middle income employment and progressive taxation helped hold inequality at a comparatively low level<span class='fn' tabindex='0' data-note='Sauer et al. (2020)'><sup>12</sup></span>.",
        text3:
          "Demographic change and the rise of non regular work added modest upward pressure but <span class='highlight' style='color:var(--color-asia)'>Japan</span> still shows one of the most stable long term inequality trajectories in the world<span class='fn' tabindex='0' data-note='IFS Deaton Review (2024)'><sup>13</sup></span>.",
      },
    },
    // --------------------------------------
    // 11. Japan vs. China
    // --------------------------------------
    {
      ...
      description: {
        ...
        text: "<span class='highlight' style='color:var(--color-asia)'>China</span> is neither one of the most equal nor unequal countries, but what stands out is its enormous economic growth in recent decades and its impact on other countries. The graph shows that the rise in productivity goes hand in hand with a rise in inequality.",
        text2: `
    ...
    // --------------------------------------
    {
      ...
      description: {
        ...
        text2:
          "countries drew closer together while internal gaps widened. The <span class='highlight' style='color:var(--color-global)'>world’s</span> line looks flat, but beneath it, everything moves.",
        text3: "",
      },
    },
  ],
